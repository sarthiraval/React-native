        ...
        <SafeAreaView style={{ marginVertical: 3, flex: 1 }}>
            ...
            <FlatList
                ...
                data={[
                    {
                        id: '1',
                        image: { url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPQzg2-modiBeSBIckt_NcpipPPGQfZA_dbQ&usqp=CAU' },
                        title: 'Ronald Richards',
                        subtitle: 'Gurgaon,india'
                    },
                    ...
                    {
                        id: '6',
                        image: { url: 'https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8bWVyY2VkZXMlMjBjYXJ8ZW58MHx8MHx8&w=1000&q=80' },
                        title: 'Floyd Miles',
                        subtitle: 'san Fransisco,CA'
                    },
...
showsVerticalScrollIndicator={false}
                renderItem={({ item }) =>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 8, marginVertical: 10 }}>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            <Image source={item.image} style={{ width: 70, height: 70, marginLeft: 20, borderRadius: 400 / 2, marginTop: 10 }} />
                            ...
                            {() => unhide(!hide)}>
                            {
                                hide
                                    ...
                                    : <Image
                                        ...
                                        style={{ marginTop: 19, width: 20, marginRight: 40, height: 15 }}
                                    />
                            }
                        </TouchableOpacity>
